                ...
                return (
                  <g
                    ...
                    onClick={(e) => {
                      ...
                      else if (ld.targetType === 'recording') router.push(`/search?q=${encodeURIComponent(ld.targetName)}`)
                      else if (ld.targetType === 'tag') router.push(`/search?q=${encodeURIComponent(ld.targetName)}`)
                    }}
                    onMouseEnter={() => {
