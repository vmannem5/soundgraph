...
// Inline theme-init script content (static string, no user input)
const themeInitScript = `(function(){var t=localStorage.getItem('genus-theme')||'dark';document.documentElement.setAttribute('data-theme',t);})();`
  ...
  return (
    <html lang="en" data-theme="dark">
      <head>
        ...
        <script src={`data:text/javascript,${encodeURIComponent(themeInitScript)}`} />
      </head>
